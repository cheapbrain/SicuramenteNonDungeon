...
public class ParticleBuilder {
	public static Entity create(float x, float y, float z, long ttl, float speedx, float speedy, float speedz, float friction){
		...
		RenderParticle rp = new RenderParticle(particle, fisica, particella, "./res/blood.png");
		return particle;
	}
}
